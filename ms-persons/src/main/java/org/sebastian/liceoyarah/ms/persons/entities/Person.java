package org.sebastian.liceoyarah.ms.persons.entities;
...
public class Person {
    ...
    @Column(name = "BARRIO", nullable = false, length = 250 )
    @Comment("Barrio de la persona")
    @Schema(description = "Barrio de la Persona")
    @NotNull
