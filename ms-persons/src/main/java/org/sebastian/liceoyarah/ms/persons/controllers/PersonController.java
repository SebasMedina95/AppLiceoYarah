package org.sebastian.liceoyarah.ms.persons.controllers;
...
import org.sebastian.liceoyarah.ms.persons.common.dtos.PaginationDto;
import org.sebastian.liceoyarah.ms.persons.common.swagger.persons.*;
import org.sebastian.liceoyarah.ms.persons.common.utils.ApiResponseConsolidation;
import org.sebastian.liceoyarah.ms.persons.common.utils.CustomPagedResourcesAssembler;
...
public class PersonController {
    ...
    private final CustomPagedResourcesAssembler<Person> customPagedResourcesAssembler;

    @Autowired
    public PersonController(
            PersonService personService,
            CustomPagedResourcesAssembler<Person> customPagedResourcesAssembler){
    ...
    public ResponseEntity<ApiResponseConsolidation<Object>> create(
        ...
        ResponseWrapper<Person> personNew = personService.create(personRequest);
    ...
    public ResponseEntity<ApiResponseConsolidation<Object>> findAll(
        ...
        Page<Person> comforts = personService.findAll(paginationDto.getSearch(), pageable); //Aplicando la paginación JPA -> Incorporo el buscador
        UriComponentsBuilder uriBuilder = ServletUriComponentsBuilder.fromCurrentRequestUri(); //Para la obtención de la URL

        PagedModel<Person> pagedModel = customPagedResourcesAssembler.toModel(comforts, uriBuilder);
    ...
    public ResponseEntity<ApiResponseConsolidation<Person>> findById(
    ...
    public ResponseEntity<ApiResponseConsolidation<Object>> update(
        ...
        ResponseWrapper<Person> personUpdate;
    ...
    public ResponseEntity<ApiResponseConsolidation<Person>> delete(
            @PathVariable("id") String id
    ){
    ...
    //* ******************************************************* *//
    //* Este buscador será usado principalmente por MS externos *//
    //* ******************************************************* *//
