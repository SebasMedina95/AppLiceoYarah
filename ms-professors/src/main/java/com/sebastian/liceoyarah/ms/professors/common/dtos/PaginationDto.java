package com.sebastian.liceoyarah.ms.professors.common.dtos;
...
public class PaginationDto {
    ...
    @Schema(description = "Número de elementos por página", example = "2")
    ...
    @Schema(description = "Orden de la paginación: 'asc' para ascendente, 'desc' para descendente", example = "asc")
    ...
    @Schema(description = "Campo por el que se debe ordenar", example = "id")
    private String sort;

    @Schema(description = "Cadena de búsqueda para filtrar resultados", example = "")
